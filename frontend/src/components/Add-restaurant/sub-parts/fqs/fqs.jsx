...
const data = [{
    q : "What will Hungrezi charge me for creating a page on its platform?",
    a : "Creating a restaurant page on Hungrezi is free of cost. You can maintain your page by replying to reviews and do a lot more without any charges."
},{
    q : "I have a large fleet of delivery boys, why should I use Hungrezi’s delivery service?",
    a : "You can use your and Hungrezi's delivery fleet simultaneously to increase the network of your delivery radius. Also, our delivery fleet delivers orders in minimum possible time, a key factor leading to increased customer satisfaction."
},{
    q : "What happens if the average order value of Hungrezi orders is very low?",
