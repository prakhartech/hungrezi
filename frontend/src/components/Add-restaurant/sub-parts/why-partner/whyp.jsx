        ...
        <div className="whyp">
            <div className='whyp-wrapper'>
                <div className='whyp-t'>
                    <h1>Why should you partner with Hungrezi?</h1>
                    <p>Hungrezi enables you to get 60% more revenue, 10x new customers and boost your brand visibility by providing insignts to improve your business.</p>
