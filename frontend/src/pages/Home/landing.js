      ...
      <div className=".poD1">
        ...
        <div className="poD2">
          ...
          <p>
            ...
            Gandhinagar, based on trends
          </p>
          <div>All collections in Gandhinagar</div>
        </div>
        <div className="mi">
          ...
          <div className="mi-container">
            ...
            <div class="mi-t">Best of Gandhinagar</div>
            <div class="mi-tt">154 Places</div>
          </div>
        </div>
        <div className="pLocation">
          <div className="BSS">Popular localities in and around Gandhinagar</div>
        </div>
        <div className="Lol">
          <div className="LolD">
            {" "}
